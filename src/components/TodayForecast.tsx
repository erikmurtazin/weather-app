  ...
  return (
    <div className="flex flex-col items-center w-full">
      <div className="lg:h-65 md:h-75 h-80 w-full flex flex-col justify-center items-center bg-small md:bg-large bg-no-repeat bg-cover bg-center rounded-xl">
        <div className="flex md:justify-between md:flex-row md:p-10 flex-col items-center justify-center w-full p-3 h-full gap-5">
          <div>
          ...
          <div className="flex items-center">
            ...
            <span className="text-text italic text-7xl">
